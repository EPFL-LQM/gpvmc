...
StatSpinStruct_1::StatSpinStruct_1(const Stepper_1* stepper,
                               FileManager* fm)
    :MatrixQuantity_1(stepper,fm,"StatSpinStruct_1",3,
...
void StatSpinStruct_1::measure()
{
    ...
    {
        string err="StatSpinStruct_1::measure: Only defined for a system of spin-1/2 particles";
#ifdef EXCEPT
...
bool StatSpinStruct_1::isup(const vector<uint_vec_t>& in)
{
    if(in.size()==1)
...
bool StatSpinStruct_1::isdo(const vector<uint_vec_t>& in)
{
    if(in.size()==1)
