...
MetroMC_1::MetroMC_1(Stepper_1* step, FileManager* fm)
...
bool MetroMC_1::YesNo(const BigDouble& in)
{
    double din(in);
#ifdef DEBUG
    if(din>1.0){
...
void MetroMC_1::Walk(const size_t& len, size_t meas)
{
...
double MetroMC_1::Rejection() const
{
    if(m_steps)
