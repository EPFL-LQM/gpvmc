...
BigComplex Amplitude_1::Amp() const {return m_amp*m_wav->GetSign();}

void Amplitude_1::VirtUpdate(const vector<vector<hop_path_t> >& rhop,
...
void Amplitude_1::Update(const vector<hop_path_t>& rhop,
