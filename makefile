...
BIN=vmc vmc_1 test_1 test
SRC=SpinState.cpp Amplitude.cpp Amplitude_1.cpp SpinOp.cpp SpinDensity.cpp Timer.cpp RanGen.cpp FileManager.cpp WaveFunction.cpp WaveFunction_1.cpp linalg.cpp MetroMC.cpp MetroMC_1.cpp Quantity.cpp Quantity_1.cpp StagFluxWaveFunction.cpp StagFluxWaveFunction_1.cpp StagFluxTransExciton.cpp StagFluxTransExciton_1.cpp Jastrow.cpp ArgParse.cpp SpinSpinCorr.cpp StagJastrow.cpp StaggMagnJastrow.cpp ScalarQuantity.cpp VectorQuantity.cpp MatrixQuantity.cpp FullSpaceStepper.cpp LatticeStepper_1.cpp ProjHeis.cpp StagFluxLongExciton.cpp StagFluxLongExciton_1.cpp StatSpinStruct.cpp State_1.cpp LatticeState_1.cpp SquareLattice.cpp VectorQuantity_1.cpp ScalarQuantity_1.cpp MatrixQuantity_1.cpp StatSpinStruct_1.cpp ProjHeis_1.cpp defs.cpp
